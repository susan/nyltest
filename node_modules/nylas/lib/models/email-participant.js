...
function (_RestfulModel) {
  _inherits(EmailParticipant, _RestfulModel);

  function EmailParticipant() {
    _classCallCheck(this, EmailParticipant);

    return _possibleConstructorReturn(this, _getPrototypeOf(EmailParticipant).apply(this, arguments));
  }

  _createClass(EmailParticipant, [{
    key: "toJSON",
    value: function toJSON() {
      var json = _get(_getPrototypeOf(EmailParticipant.prototype), "toJSON", this).apply(this, arguments);
