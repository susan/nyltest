...
function (_RestfulModel) {
  _inherits(EventParticipant, _RestfulModel);

  function EventParticipant() {
    _classCallCheck(this, EventParticipant);

    return _possibleConstructorReturn(this, _getPrototypeOf(EventParticipant).apply(this, arguments));
  }

  _createClass(EventParticipant, [{
    key: "toJSON",
    value: function toJSON() {
      var json = _get(_getPrototypeOf(EventParticipant.prototype), "toJSON", this).apply(this, arguments);
